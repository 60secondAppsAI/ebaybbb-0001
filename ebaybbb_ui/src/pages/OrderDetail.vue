						...
						<td style="width: 100%;"></td>
				        	...
				        	<td style="width: 150px;">
								...
								<div id="app">
								  ...
								  <base-input label="Quantity" type="text" placeholder="Enter Quantity" v-model="orderToAdd.quantity"></base-input>
												                  </form>
								                </div>
            ...
            <div style="text-align: center; padding: 20px;">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Quantity</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Quantity" type="text" placeholder="Enter Quantity" v-model="orderDetails.quantity"></input>
																		</div>
						</td>
														</tr>
